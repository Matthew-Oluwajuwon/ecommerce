 ...
 *         schema:
 *           type: integer
 *         description: The number of products per page (default is 10, max is 100)
 *     responses:
 *       200:
 ...
 *         description: Internal server error
 */
productRoutes.get("/", authenticateJWT_1.default, product_1.getAllProducts);
/**
 * @swagger
 * /api/v1/product/{id}:
 *   get:
 ...
 *         description: Internal server error
 */
productRoutes.get("/:id", authenticateJWT_1.default, product_1.getProductById);
/**
 * @swagger
 * /api/v1/product:
 *   post:
 ...
 *                   example: null
 */
productRoutes.post("/", authenticateJWT_1.default, product_1.createProduct);
/**
 * @swagger
 * /api/v1/product/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
productRoutes.put("/:id", authenticateJWT_1.default, product_1.updateProduct);
/**
 * @swagger
 * /api/v1/product/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
productRoutes.delete("/:id", authenticateJWT_1.default, product_1.deleteProduct);
