 ...
 *                   example: null
 */
authenticationRoutes.post("/register", authentication_1.register);
/**
 * @swagger
 ...
 */
authenticationRoutes.post("/login", authentication_1.login);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
authenticationRoutes.get("/get-user-info", authenticateJWT_1.default, authentication_1.getUserInfo);
/**
 * @swagger
 ...
 *                   example: null
 */
authenticationRoutes.put("/update-user-profile", authenticateJWT_1.default, authentication_1.updateUser);
/**
 * @swagger
 ...
 *                   example: "Internal Server Error"
 */
authenticationRoutes.post("/forgot-password", authentication_1.forgotPassword);
/**
 * @swagger
 ...
 *                   example: null
 */
authenticationRoutes.post("/change-password", authentication_1.changePassword);
/**
 * @swagger
 ...
 *                   type: null
 */
authenticationRoutes.post("/approve-user", authenticateJWT_1.default, authentication_1.approveOrDisapproveUser);
